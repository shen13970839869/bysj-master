...
//修改学生
    ...
    private String selectexam(Model model,Integer pageNum,HttpSession session){
    ...
    private String paperDetails (Integer eid,Model model,HttpSession session){
        Users attribute = (Users) session.getAttribute("Tlis");
        if (attribute==null){
            return "redirect:/login";
        }
    ...
    private String insertexam(String pname,Integer userid, Integer cno,  Integer classid, Integer singlenumber, Integer singlecore, Integer multiplenumber, Integer multiplecore, Date examdate,Date examtime,Integer testtime,Model model,HttpSession session){
        Users attribute = (Users) session.getAttribute("Tlis");
        if (attribute==null){
            return "redirect:/login";
        }
  ...
  private String findAllScore(HttpServletRequest request,Integer pageNum,Model model,HttpSession session){
        Users attribute = (Users) session.getAttribute("Tlis");
        if (attribute==null){
            return "redirect:/login";
        }
