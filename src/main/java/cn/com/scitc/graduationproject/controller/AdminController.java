...
public class AdminController {
    ...
    private String AdminCourseManage(Model model, HttpSession session){
        Users attribute = (Users) session.getAttribute("Alis");
        if (attribute==null){
    ...
    private String updateCourse(Course course ,HttpSession session){
        Users attribute = (Users) session.getAttribute("Alis");
        if (attribute==null){
            return "redirect:/login";
        }
    ...
    private String addCourse(String cname,HttpSession session){
        Users attribute = (Users) session.getAttribute("Alis");
        if (attribute==null){
            return "redirect:/login";
        }
    ...
    private  String AdminPjclassManage(Model model,HttpSession session){
        Users attribute = (Users) session.getAttribute("Alis");
        if (attribute==null){
            return "redirect:/login";
        }
    ...
    private String AdminTeacherManage(Model model,Integer pageNum,HttpSession session){
        Users attribute = (Users) session.getAttribute("Alis");
        if (attribute==null){
            return "redirect:/login";
        }
